...
(unless pm/initialized (load-theme 'modus-operandi-tinted t)) ; only call on initialization
...
(setq org-todo-keywords
      '((sequence
         ...
         "IDEA(i!)" ;; A task which might occur
...
#+begin_src emacs-lisp
(defun pm/daily-note-file () (file "%/%Y/%m/%Y-%m-%d.org"))
(defvar pm/heading-timestamps "#+created_at: %U\n#+last_modified: %U\n")
(defvar pm/note-heading (concat "#+title: ${title}\n" pm/heading-timestamps))
(defun pm/note-heading-with-default-tag (tag)
  (concat pm/note-heading "#+filetags :" (format "%s" tag) ":%^G\n\n"))
...
Intialise a default file path for each daily document to follow


#+begin_src emacs-lisp
(defun pm/org-insert-todo-subheading ()
