...
#+begin_src emacs-lisp
(defun my-org-capture-example (&optional arg)
  (interactive "P")
  (cond
   ((equal arg '(4)) (message "You pressed C-u once"))
   ((equal arg '(16)) (message "You pressed C-u twice"))
   (t (message "You did not press C-u or pressed it more than twice"))))
#+end_src
**** Projects
*** Keybinds
**** Generic
